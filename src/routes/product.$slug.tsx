        ...
        <div className="grid grid-cols-[72px_1fr] gap-3">
          ...
          <div className="mt-6 grid sm:grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 bg-foreground text-background px-6 py-4 text-sm uppercase tracking-widest font-semibold hover:opacity-85 transition"
            >
              <ShoppingBag className="h-4 w-4" /> Add to Cart
            </button>
            <button
              onClick={() => handleAdd(true)}
              className="flex items-center justify-center gap-2 border-2 border-foreground text-foreground px-6 py-4 text-sm uppercase tracking-widest font-semibold hover:bg-foreground hover:text-background transition"
            >
